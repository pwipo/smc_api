...
public enum MessageType {
    ...
    EXTEND_EXTERNAL_DATA_GET_ID/*(103)*/,
    EXTEND_EXTERNAL_DATA_GET_DATA/*(104)*/,
    EXTEND_EC_PARAM_SEND_ID/*(105)*/,
    EXTEND_EC_PARAM_SEND_DATA/*(106)*/,
    EXTEND_EXTERNAL_EC_PARAM_SEND_ID/*(107)*/,
    EXTEND_EXTERNAL_EC_PARAM_SEND_DATA/*(108)*/,
    EXTEND_EC_PARAM_RETURN_ID/*(109)*/,
    EXTEND_EC_PARAM_RETURN_DATA/*(110)*/,
    EXTEND_EXTERNAL_EC_PARAM_RETURN_ID/*(111)*/,
    EXTEND_EXTERNAL_EC_PARAM_RETURN_DATA/*(112)*/,

    FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_START/*(26)*/,
    FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_EXECUTE/*(27)*/,
    FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_UPDATE/*(28)*/,
    FLOW_CONTROL_EXTERNAL_EC_EXECUTE_NOW_STOP/*(29)*/,
    FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_START/*(30)*/,
    FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_EXECUTE/*(31)*/,
    FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_UPDATE/*(32)*/,
    FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_STOP/*(33)*/,
    FLOW_CONTROL_EXTERNAL_EC_EXECUTE_PARALLEL_WAITING_TACTS/*(34)*/,
